...
class Animal {
  name: string;
  isPredator: boolean;
  constructor(name: string, isPredator: boolean) {
...
class WildAnimal extends Animal {
  age: number;
  constructor(name: string, isPredator: boolean, age: number) {
    super(name, isPredator);
    this.age = age;
  }
}

let lion: WildAnimal = new WildAnimal("Alex", true, 5);
console.log(lion);
...
let dog: HomeAnimal = new HomeAnimal("Kuchuk", true, 13);
console.log(dog);
...
let bmw: NewCar = new NewCar("BMW", 2023);
console.log(NewCar);
